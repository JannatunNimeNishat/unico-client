...
const StaffsPage = () => {
    return (
        <div>
        {/* banner */}
        <div className="bg-[url('/staffs/Staffs.jpg')] h-[40vh] bg-cover bg-center">
            <div className='backdrop-brightness-50 w-full h-full flex flex-col  px-8 justify-center'>
                <h3 className='text-5xl font-bold text-white '>Faculty & Staffs</h3>
        ...
        <div className='mt-20'>
            <h3 className='text-3xl font-bold text-center w-2/3 mx-auto leading-relaxed'>Resources, offices and services that support UNICO faculty and staff</h3>

            {/* academic resources and campus life */}
            <div className='flex gap-8 my-container mt-12'>
                {/* 1st */}
                <div className='flex-1'>
                    <Image className='h-[300px] w-[580px]' height={200} width={500} src={'/staffs/Staffs1.jpg'} alt='' />
                    <div className='mt-8 '>
                        <h3 className='text-3xl font-bold'>Staff Benefits & Resources</h3>
                ...
                {/* 2nd */}
                <div className='flex-1'>
                    <Image className='h-[300px] w-[580px]' height={200} width={500} src={'/staffs/Staffs3.jpg'} alt='' />
                    <div className='mt-8'>
                        <h3 className='text-3xl font-bold'>Faculty Resources</h3>
            ...
            <div className='flex gap-8 my-container mt-12'>
                {/* 1st */}
                <div className='flex-1'>
                    <Image className='h-[300px] w-[580px]' height={200} width={500} src={'/staffs/Staffs4.jpg'} alt='' />
                    <div className='mt-8 '>
                ...
                {/* 2nd */}
                <div className='flex-1'>
                    <Image className='h-[300px] w-[580px]' height={200} width={500} src={'/staffs/Staffs5.jpg'} alt='' />
                    <div className='mt-8'>
